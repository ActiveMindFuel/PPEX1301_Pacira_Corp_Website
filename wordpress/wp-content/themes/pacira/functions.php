<?php
/*
Author: Active Mind Fuel
URL: http://activemindfuel.com
...
function bones_ahoy() {
  ...
  function enqueue_my_scripts() {
    ...
    wp_enqueue_script( 'slick-slider-js', '//cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.5.9/slick.min.js', true );
  ...
  function enqueue_my_styles() {
    ...
    wp_enqueue_script( 'slick-slider', '//cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.5.9/slick.min.css' );
